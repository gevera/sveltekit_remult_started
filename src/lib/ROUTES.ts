...
const SERVERS = {
  ...
  "GET /api/images/[filename]": (params: { filename: (string | number) }) => {
    return `/api/images/${params['filename']}`
  }
}
...
const ACTIONS = {
  "logout /": `/?/logout`,
  "delete /admin/files": `/admin/files?/delete`,
  "upload /admin/files": `/admin/files?/upload`,
